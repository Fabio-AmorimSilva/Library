...
public class CreateBookCommandValidator : AbstractValidator<CreateBookCommand>
{
    public CreateBookCommandValidator()
    {
        ...
        RuleFor(command => command.Title)
            ...
            .WithMessage(ErrorMessages.HasMaxLength(nameof(CreateBookCommand.Title),
                Domain.Entities.Book.TitleMaxLength));

        RuleFor(command => command.Pages)
            .Must(p => p > Domain.Entities.Book.PagesMinLength)
            .WithMessage(ErrorMessages.HasToBeGreaterThan(nameof(CreateBookCommand.Pages),
                Domain.Entities.Book.PagesMinLength));
