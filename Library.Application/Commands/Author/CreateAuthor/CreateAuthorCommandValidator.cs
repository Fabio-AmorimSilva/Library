...
public class CreateAuthorCommandValidator : AbstractValidator<CreateAuthorCommand>
{
    public CreateAuthorCommandValidator()
    {
        ...
        RuleFor(command => command.Name)
            ...
            .WithMessage(ErrorMessages.HasMaxLength(nameof(CreateAuthorCommand.Name),
                Domain.Entities.Author.NameMaxLength));
        ...
        RuleFor(command => command.Country)
            ...
            .WithMessage(ErrorMessages.HasMaxLength(nameof(CreateAuthorCommand.Country),
                Domain.Entities.Author.CountryMaxLength));
